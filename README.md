...
1. **Project Overview** — problem statement, objectives, and pipeline summary  ![Project Overview](Project_Overview.png)
2. **Global Flight Traffic** — world map of flight positions, ground status, top countries by volume  ![Global_Flight](Global_Flight.png)
...
4. **Visibility Analysis** — speed and flight volume by visibility category, including a low-altitude subset comparison  ![Visibility Analysis](Visibility_Analysis.png)
5. **Key Findings & Conclusion** — summary of results and closing insights  ![Key Findings](Key_Insight.png)
